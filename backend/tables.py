...
class Watchlist(Base):
    ...
    # Position planning
    planned_sl_pct = Column(Numeric(10, 4))
...
class PartialExit(Base):
    ...
    r_multiple_at_exit = Column(Numeric(10, 4))
...
class ActionAlert(Base):
    ...
    rpt_pct_used = Column(Numeric(10, 4))
    trp_pct = Column(Numeric(10, 4))

    # SELL-specific fields
    trade_id = Column(Integer, ForeignKey("trades.id"))
    exit_qty = Column(Integer)
    exit_pct = Column(Numeric(10, 4))
